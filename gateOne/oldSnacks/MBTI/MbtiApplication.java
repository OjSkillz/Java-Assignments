...
public class MbtiApplication {
  public static void main(String...args) {
    ...
    System.out.print("\nHi! , this is the Myers-Briggs Personality Test. What is your name?  ");
    ...
    for (int index = 0; index < testQuestions.length; index += 4){
      ...
      System.out.println("\nFor this section , you Selected:  ");
      
      for (int index = 0; index < outputs.length -1; index += 4) System.out.println("\n" + outputs[index]);
      System.out.println("\nNumber of As selected: " + extroverted + "\nNumber of Bs selected: " + introverted);
      
      if (extroverted > introverted) {
      System.out.println("\nExtroverted (E) vs Introverted (I) : "+ extrovert); 
      personality += "E";
      }
      else {
      System.out.println("\nExtroverted (E) vs" + " Introverted (I) : " + introvert);
      personality += "I";
      }
      ...
      System.out.println("\nNumber of As selected: " + sensing + "\nNumber of Bs selected: " + intuitive);
      ...
      System.out.println("\nNumber of As selected: " + thinking + "\nNumber of Bs selected: " + feeling);
      ...
      System.out.println("\nNumber of As selected: " + judging + "\nNumber of Bs selected: " + perceptive);
